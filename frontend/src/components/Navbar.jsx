      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto align-items-center">
            ...
            <Nav.Link as={Link} to="/history" className="px-3" style={{ fontSize: "1.05rem", fontWeight: "500", color: "rgba(255,255,255,0.85)", transition: "color 0.2s" }}>
              History
            </Nav.Link>
            <Nav.Link as={Link} to="/about" className="px-3" style={{ fontSize: "1.05rem", fontWeight: "500", color: "rgba(255,255,255,0.85)", transition: "color 0.2s" }}>
              About
            </Nav.Link>
